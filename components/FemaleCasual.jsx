...
export default function FemaleCasual(props) {
  const { nodes, materials } = useGLTF(require('../assets/models/female_casual.glb'))
  ...
  return (
    <group {...props} dispose={null} ref={meshRef} position={[0, -0.7, 0]}>
      <group name="Sketchfab_Scene">
        <group name="Sketchfab_model" rotation={[-Math.PI / 2, 0, 0]} scale={0.88}>
          <group name="6d2a73d8f1e74c9590527501e7d40976fbx" rotation={[Math.PI / 2, 0, 0]}>
            <group name="Object_2">
              <group name="RootNode">
                <group name="AvatarRoot">
                  <group name="Object_5">
                    ...
                    <group name="haircut" />
                    <group name="outfit_bottom" />
                    <group name="outfit_shoes" />
                    <group name="outfit_top" />
                  </group>
                </group>
              </group>
            </group>
...
useGLTF.preload(require('../assets/models/female_casual.glb'))
